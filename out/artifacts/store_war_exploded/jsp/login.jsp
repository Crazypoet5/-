...
<form class="form-horizontal" action="${pageContext.request.contextPath}/user?method=login" method="post">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-6">
      <input type="text" class="form-control" id="username" placeholder="请输入用户名" name="username" value="${last_login_name}">
    </div>
  </div>
   <div class="form-group">
    <label for="inputPassword3" class="col-sm-2 control-label">密码</label>
    <div class="col-sm-6">
      <input type="password" class="form-control" id="inputPassword3" placeholder="请输入密码" name="password" value="${last_login_pw}">
    </div>
  </div>
   <div class="form-group">
    ...
    <div class="col-sm-offset-2 col-sm-10">
      <div class="checkbox">
        ...
        <label>
          <input type="checkbox" name="memory" value="yes"> 记住用户名
        </label>
      </div>
    </div>
  </div>
